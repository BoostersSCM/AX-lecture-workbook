...
export const PROMPT_HELP = {
  ...
  setup: {
    ...
    steps: ['Notion 연결을 확인합니다.', '프롬프트를 복사해 Claude에 붙여넣습니다.', '페이지 제목이나 목록만 보이는지 확인합니다.'],
  },
  s1a: {
    ...
    steps: ['AX 실습장이 있으면 먼저 확인합니다.', '비어 있으면 연결 준비에서 정한 실제 연습용 페이지를 기준으로 합니다.', '결과에 자료 이름·위치·읽지 않을 범위를 기록합니다.'],
  },
  s1b: {
    ...
    steps: ['페이지명을 입력란에 복사해 넣습니다.', '페이지명에 맞춰 바뀐 프롬프트를 복사합니다.', '각 요약 뒤에 원문 근거를 붙이고, 없는 값은 미확인으로 남깁니다.'],
  },
  s1c: {
  ...
  s2insert: {
    ...
    steps: ['최종 액션아이템 표를 s2.action_items 입력란에 붙여넣습니다.', '자동 저장 상태가 저장됨으로 바뀌는지 봅니다.', '4회차에서 같은 값을 다시 불러옵니다.'],
  },
  s3asana: {
